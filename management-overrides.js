(()=>{'use strict';
const css=document.createElement('style');css.textContent='[data-view="map"]{display:none!important}.activity-delete,.volunteer-delete{border:1px solid #f0c8cd!important;color:#c53d4b!important;background:#fff!important}.activity-delete:hover,.volunteer-delete:hover{background:#fff4f5!important}';document.head.appendChild(css);
